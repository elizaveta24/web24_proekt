            ...
            <div class="card">
				...
				<div class="album py-5 bg-light">
                    <form method="POST" action="{{ route('register') }}">
						...
						<div class="form-group row">
                            <label for="age" class="col-md-4 col-form-label text-md-right">{{ __('Возраст') }}</label>

                            <div class="col-md-6">
                                <input id="age" type="number_format" class="form-control @error('age') is-invalid @enderror" name="age" value="{{ old('age') }}" required autocomplete="age" autofocus>
							...
							<div class="form-group row">
                            <label for="level" class="col-md-4 col-form-label text-md-right">{{ __('Уровень английского') }}</label>
